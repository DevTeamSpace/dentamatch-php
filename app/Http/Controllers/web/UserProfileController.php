...
class UserProfileController extends Controller
{
    ...
    public function officeDetails(Request $request)
    {
        ...
        if (isset($request->phoneNumber) && !empty($request->phoneNumber)) {
            ...
            $newPhone = str_replace(['+', '-'], '', $var);
            $request->merge(['contactNumber' => $newPhone]);
        }
     ...
     */
    private static function createRecruiterOfficeAddress($request)
    {
        ...
        $recOfficeArr = [
            ...
            'address_second_line' => $request->officeAddressSecondLine,
     ...
     */
    private static function createRecruiterOfficeAddress1($request)
    {
        ...
        $recOfficeArr = [
            ...
            'address_second_line' => $request->officeAddressSecondLine1,
     ...
     */
    private static function createRecruiterOfficeAddress2($request)
    {
        ...
        $recOfficeArr = [
            ...
            'address_second_line' => $request->officeAddressSecondLine2,
    ...
    /**
     * Form from /home page to create first office and office name
    ...
    /**
     * Ajax request from /edit-profile
     * @return array
     */
    ...
    /**
     * Ajax post request from /edit-profile
     * @param EditRecruiterOfficeRequest $request
     * @return array
     * @throws \Exception
     */
    public function postEditRecruiterOffice(EditRecruiterOfficeRequest $request)
    {
        try {
            ...
            if ($checkRecruiterOfficeExistence != null) {
                ...
                $recruiterOfficeObj->address_second_line = $allData->officeAddressSecondLine;
