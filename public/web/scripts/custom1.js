...
//masterCLone = $(".masterBox:first").children().clone()
            ...
            var hiddenFields = '<input class="field" id="postal_code'+dynamicLength+'" name="postal_code'+dynamicLength+'" ><input type="text" name="lat'+dynamicLength+'" id="lat'+dynamicLength+'"><input type="text" name="lng'+dynamicLength+'" id="lng'+dynamicLength+'"><input type="text" name="full_address'+dynamicLength+'" id="full_address'+dynamicLength+'">';
