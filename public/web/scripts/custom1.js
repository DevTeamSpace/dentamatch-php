$(function () {
    ...
    function dynamicBox() {
        ...
        if ($(this).hasClass('DynamicAddder')) {
            currentEvent = $(this);
            dynamicDiv = $(document.body).find(".profieBox").append("<div class='commonBox cboxbottom masterBox'><div> ");
