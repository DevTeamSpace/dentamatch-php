...
//masterCLone = $(".masterBox:first").children().clone()
            ...
            var hiddenFields = '<input type="hidden" name="_token" value="'+tokenValue+'" ><div id="officeDetail-errors'+dynamicLength+'"></div><input type="text" style="display:none;" data-parsley-required data-parsley-required-message="" id="postal_code'+dynamicLength+'" name="postal_code"  ><input type="hidden" name="lat" id="lat'+dynamicLength+'"><input type="hidden" name="lng" id="lng'+dynamicLength+'"><input type="hidden" name="full_address" id="full_address'+dynamicLength+'">';
