$(function() {
    ...
    function totalCount() {
        ...
        $('.DynamicAddder').html(`<span class='icon icon-plus'></span>Add up to ${3 - boxLength} Office Locations`);
        if (boxLength >= 3) {
