...
// });
    ...
    function lengthRestriction(event) {
        ...
        $(".DynamicAddder").html('<span class="icon icon-plus"></span>Add up to ' + total + ' Office Locations');
        if (dynamicLength >= 3) {
