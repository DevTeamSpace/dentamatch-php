            ...
            function highlightStars(current) {
                ...
                for(i = 1; i <= 5; i++) {
                    if(i <= current) {
                        ...
                        $container.find('i[rating-value=' + i + ']').css('border-right-color', '#f3f3f3');
                        $container.find('i[rating-value=' + i + ']').addClass('active');
                        
                    } else {
                        $container.find('i[rating-value=' + i + ']').css('background-color', self.settings.color);
                        $container.find('i[rating-value=' + i + ']').css('border-right-color', '#d7d7d7');
                        $container.find('i[rating-value=' + i + ']').removeClass('active');
                    }
                }
