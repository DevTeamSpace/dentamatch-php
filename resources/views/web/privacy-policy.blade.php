...
<div class="container globalpadder">
    ...
    <div class="row">
        ...
        <h5 class="pg-heading mr-b-30">Personal identification information</h5>
        <p class="mr-t-30">
        ...
        <h5 class="pg-heading mr-b-30">Non-personal identification information</h5>
        <p class="mr-t-30">
        ...
        <h5 class="pg-heading mr-b-30">Web browser cookies</h5>
        <p class="mr-t-30">Our Site may use "cookies" to enhance User experience. User's web browser places cookies on their hard drive
        ...
        <h5 class="pg-heading mr-b-30">How we use collected information</h5>
        <p class="mr-t-30">
        ...
        <ul class="privacy-ul">
                ...
                and resources provided on our Site.</li>
