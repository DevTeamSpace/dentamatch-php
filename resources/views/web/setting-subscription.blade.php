    ...
    <div class="row" id="subscription">
      ...
      <div class="col-sm-8 ">
          ...
          <div class="descriptionBox">
            ...
            <div class="tabSubscriptionMainContainer">
              ...
              <div class="tabSubscriptionContainer">
                ...
                <a class="pull-right" href="#" data-bind="visible: resubscribeButton,click: $root.subscribeAgain">Subscribe
                  Again</a>
                ...
                <div class="table-responsive">
                  ...
                  <p>Your next <span data-bind="text: subscriptionPlan"></span> charge of <span
                            data-bind="text: subscriptionAmount"></span> will be applied to your primary payment method
                    on <span data-bind="text: subscriptionAutoRenewal"></span>.</p>
                  <!--/ko-->
                  <div class="text-right" data-bind="visible: switchVisible">
                    <button type="submit" class="btn btn-primary pd-l-30 pd-r-30 mr-t-10"
                            data-bind="text: switchToText, click: $root.switchTo"> Quarterly
                    </button>
                    <button type="submit" class="btn btn-primary pd-l-30 pd-r-30 mr-t-10"
                            data-bind="text: switchToText1, click: $root.switchTo"> Semi Annual
                    </button>
                  ...
                  <div class="masterCardBox small-border-radius dev_card_box">
                    ...
                    <div class="masterEDOPtion pull-right"><span class="gbllist dev_edit_button"
                                                                 data-bind="click: $root.editCard"><i
                                class="icon icon-edit"></i> Edit</span>
                      <span class="gbllist" data-bind="click: $root.deleteCard"><i class="icon icon-deleteicon"></i> Delete</span>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <!--/ko-->
                  <a href="#" class="pull-right pd-t-10 pd-b-20" data-bind="visible: addCardVisible,click: addCard"><b>Add
                      Card</b></a>
        ...
        <div class="resp-tabs-container commonBox profilePadding cboxbottom "
             data-bind="visible: isLoadingSubscription">
        ...
        <div id="editCardModal" class="modal fade" tabindex="-1" role="dialog">
          <div class="modal-dialog custom-modal modal-sm" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                        data-bind="visible: cancelButtonEdit"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="editExpiry" placeholder="MM/YYYY"
                           data-bind="value: editExpiry, valueUpdate: 'keyup'">
                  </div>
                  <div class="mr-t-20 mr-b-30 dev-pd-l-13p">
                    <button type="button" class="btn btn-link mr-r-5" data-dismiss="modal">Close</button>
                    <button type="submit" id="editCardButton" class="btn btn-primary pd-l-30 pd-r-30">Update Card
                    </button>
                  </div>
                </div>
              </form>
        ...
        <div id="actionModal" class="modal fade" role="dialog">
          <div class="modal-dialog custom-modal modal-sm">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" data-bind="visible:cancelButtonDelete">
                  &times;
                </button>
              ...
              <div class="modal-body">
                ...
                <div class="mr-t-20 mr-b-30 dev-pd-l-13p" data-bind="visible: showModalFooter">
                  ...
                  <button type="submit" id="actionButton" class="btn btn-primary pd-l-30 pd-r-30"
                          data-bind="text: actionButtonText"></button>
                </div>
              </div>
            </div>
          </div>
