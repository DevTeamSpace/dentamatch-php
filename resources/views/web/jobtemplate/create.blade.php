      ...
      <div class="profieBox">
        ...
        <div class="commonBox cboxbottom">
          ...
          <div class="form-group">
            ...
            <input placeholder="Example: Dental Assistant Temp"
                   value="{{ (isset($templateData->templateName)?$templateData->templateName:'') }}" name="templateName"
                   type="text" class="form-control" data-parsley-pattern="/^[a-zA-Z0-9\.\-\s]+$/" data-parsley-required
          ...
          <div class="form-group">
            ...
            <div class="slt custom-select">
              <select id="jobTitleId" name="jobTitleId" class="selectpicker" data-parsley-required
                      data-parsley-required-message="Required">
          ...
          <div class="form-group">
            ...
            <textarea name="templateDesc" class="form-control chacterValidtion txtHeight" maxlength="1000"
                      data-parsley-required
                      data-parsley-required-message="Required">{{ (isset($templateData->templateDesc)?$templateData->templateDesc:'') }}</textarea>
          </div>
