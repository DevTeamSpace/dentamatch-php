          ...
          <div class="frm-inr-credbox bg-white ">
            ...
            <div class="tab-content">
              <div id="signup" class="tab-pane fade">
                <form id="signup-frm" method="post" action="{{ url('signup') }}" name="signupform" autocomplete="off"
                  ...
                  <div class="floating-label">
                    <div class="form-group ">
                      ...
                      <input type="email" name="email" class="form-control" id="signup-email"
                             data-parsley-changed="keyup" data-parsley-pattern="/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/"
                             data-parsley-pattern-message="Enter valid Email Id"
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="password" class="form-control " id="signup-pwd" required
                             data-parsley-trigger="keyup" data-parsley-length="[6, 14]"
                             data-parsley-length-message="Password should be 6-14 characters long"
                             data-parsley-required-message="Password required">
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="signup-confirmpwd">Confirm Password</label>
                      <input type="password" name="confirmPassword" class="form-control " id="signup-confirmpwd"
                             required data-parsley-trigger="keyup" data-parsley-length="[6, 14]"
                             data-parsley-length-message="Password should be 6-14 characters long"
                             data-parsley-required-message="Password required" data-parsley-equalto="#signup-pwd"
                ...
                <div class="f14w300 mr-t-20">Download our <a href="#">iOS</a> or <a href="#">Android</a> app if you’re
                  dental professional looking for temp, full-time, or part-time work.
                </div>
              </div>
              <div id="login" class="tab-pane fade in active">
                ...
                @endif
                <form id="signin-frm" method="post" action="{{ url('login') }}" name="loginform" autocomplete="off"
                      data-parsley-validate="">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="floating-label">
                    <div class="form-group ">
