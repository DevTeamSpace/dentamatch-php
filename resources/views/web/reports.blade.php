                  ...
                  <div class="detailTitleBlock profilePadding">
                    ...
                    <div class="row">
                      <div class="col-sm-4 col-xs-12 text-left">
                        ...
                        <input type="checkbox" {{ $checked }} onchange="javascript:loadReportData();"
                               id="includeDeleted" name="includeDeleted" value="1"
                        ...
                        <div class="form-group">
                          <div class='input-group date' id='datetimepicker7' data-bind="datetimePicker: {opt:filterTo}">
                            <input type='text' class="form-control" placeholder="To"
                                   data-bind="value: filterTo, event: {update: $root.filterList}"/>
                      ...
                      <div class="col-sm-3 col-xs-12 pull-right mr-b-10">
                        <div class="form-group">
                          <div class='input-group date' id='datetimepicker6'
                               data-bind="datetimePicker: {opt:filterFrom}">
                              ...
                              <ul class="list-hired">
                                ...
                                <li>
                                  <a href="#" data-toggle="tooltip" data-placement="bottom"
                                     data-bind="attr: {title: seekerName, 'href': seekerUrl}, event: {mouseover: $root.showToolTip}">
                                    <img class="cir-28 img-circle" src="http://placehold.it/28x28"
                                         onerror="this.src = 'http://placehold.it/28x28'"
                                         data-bind="attr: {src: seekerProfilePic}">
                                  </a>
                                </li>
                                <!--/ko-->
                                <!--/ko-->
                    ...
                    <div class="media">
                      <div class="media-left ">
                        <img src="http://placehold.it/28x28" onerror="this.src = 'http://placehold.it/28x28'"
                             data-bind="attr: {src: seekerProfilePic}" class="img-circle cir-55">
                      </div>
