      ...
      <div class="profieBox">
        ...
        <div class="commonBox cboxbottom">
          ...
          <div class="form-group">
            ...
            <input placeholder="First Name" value="{{ app('request')->input('firstName') }}" name="firstName"
                   type="text" class="form-control" data-parsley-required
                   data-parsley-required-message="First name is required">
          </div>
          <div class="form-group">
            <label>Last Name</label>
            <input placeholder="Last Name" value="{{ app('request')->input('lastName') }}" name="lastName" type="text"
                   class="form-control" data-parsley-required data-parsley-required-message="Last name is required">
          </div>
          <div class="form-group">
            <label>Email</label>
            <input placeholder="Email" value="{{ app('request')->input('email') }}" name="email" type="email"
                   class="form-control" data-parsley-required data-parsley-required-message="Email is required">
          </div>
          ...
          <div class="liscenceGroup licenseId">
            <div class="form-group">
              <label>License</label>
              <input placeholder="License No" value="{{ app('request')->input('license') }}" name="license" type="text"
                     class="form-control">
            </div>
            <div class="form-group">
              <label>License State</label>
              <input placeholder="State" value="{{ app('request')->input('state') }}" name="state" type="text"
                     class="form-control">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea data-parsley-required data-parsley-required-message="About me is required" class="form-control"
