        ...
        <div class="col-sm-4 col-md-3">
            <div id="ChildVerticalTab_1"  class="cboxbottom">
                <ul class="resp-tabs-list ver_1 small-border-radius  decoration">
                    <li><a href ="javascript:void(0);"><span class="icon icon-account-circle  "></span>Profile</a></li>
                    <li><a href ="javascript:void(0);"><span class="icon icon-drive-document "></span>Reports</a></li>
                    <li class="resp-tab-active"><a href ="javascript:void(0);"><span class="icon icon-lock "></span>Change Password</a></li>
                    <li><a href ="javascript:void(0);"><span class="icon icon-drive-form "></span>Terms & Conditions</a></li>
                    <li>
