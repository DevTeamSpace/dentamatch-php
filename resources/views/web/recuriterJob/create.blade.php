    ...
    <form data-parsley-validate method="post" action="{{ url('createJob/saveOrUpdate') }}">
        ...
        <div class="commonBox cboxbottom padding-dentaltemplate">
            ...
            <div class="form-group  job-opening hide">
                ...
                <input name="noOfJobs" type="text" id="jobopening" class="form-control"  data-parsley-pattern="^[0-9]*$" data-parsley-pattern-message="numeric only " data-parsley-required data-parsley-required-message="required"/>
            </div>
        </div>  
    </form>
</div>    
