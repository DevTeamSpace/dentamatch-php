    ...
    <form data-parsley-validate method="post" action="{{ url('createJob/saveOrUpdate') }}" novalidate
      ...
      <div class="commonBox cboxbottom padding-dentaltemplate">
        ...
        <div class="form-group custom-select">
          ...
          <select data-parsley-required data-parsley-required-message="Select Office Location" name="dentalOfficeId"
                  id="dentalOfficeId" class="selectpicker mr-b-5">
          ...
          <p class="error-div hide">We do not currently support this location, but we hope to be available there
            soon!</p>
        ...
        <div class="form-group custom-select">
          ...
          <select data-parsley-required data-parsley-required-message="Select preferred location"
                  name="preferredJobLocationId" id="preferredJobLocationId" class="selectpicker mr-b-5">
          ...
          <div class="row">
            <div class="col-md-4 col-lg-4 ">
              <div class="full-time-box">
                <input class="magic-radio" type="radio" name="jobType" id="temporary"
                       value="{{ \App\Enums\JobType::TEMPORARY }}">
            ...
            <div class="col-md-4  col-lg-4 ">
              <div class="full-time-box">
                <input class="magic-radio" type="radio" name="jobType" id="parttime"
                       value="{{ \App\Enums\JobType::PARTTIME }}">
                <label for="Part Time">
                  Part Time
                </label>
                <select data-parsley-required="false" data-parsley-required-message="select days" name="partTimeDays[]"
                        multiple="multiple" id="monthSelect" style="display: none;" class="select-days-custom">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="full-time-box">
                <input data-parsley-required data-parsley-required-message="job type required" class="magic-radio"
                       type="radio" name="jobType" id="fulltime" value="{{ \App\Enums\JobType::FULLTIME }}">
                <label for="Full Time">
                  Full Time
                </label>
              </div>
        ...
        <div class="form-group  job-opening hide">
          ...
          <input name="noOfJobs" type="text" id="jobopening" class="form-control" data-parsley-min="1"
                 data-parsley-pattern="^[0-9]*$" data-parsley-pattern-message="numeric only "
                 data-parsley-required-message="Please enter number of candidates"
                 data-parsley-min-message="zero should not be allowed"/>
        </div>
        <div class="form-group job-opening hide">
          <label>Hourly Wage Offered</label>
          <div class="row">
            <div class="col-md-4 col-lg-4">
              <input placeholder="Amount will be in $" name="payRate" type="text" id="payRate" class="form-control"
                     data-parsley-min="1" data-parsley-pattern="^[0-9]*$" data-parsley-pattern-message="numeric only "
                     data-parsley-required-message="Please enter pay rate"
                     data-parsley-min-message="zero should not be allowed"/>
            </div>
            @if($payrateUrl!='')
