            ...
            <div class="modal-body ">
                <form action="{{ url('recruiter/rating') }}" method="post">
                    ...
                    <ul class="mr-t-40 rating-box">
                        <li class="row">
                            <div class="col-sm-6">
                                <div class="rating_on"> Punctuality<span class="ex-text">(Did they show up & were they on time?)</span></div>
                            </div>
                            <div class="col-sm-6 ">
                        ...
                        <li class="row">
                            <div class="col-sm-6 ">
                                <div class="rating_on"> Work performance <span class="ex-text">(Were they efficient? Were they a team player?)</span></div>
                            </div>
                            <div class="col-sm-6 ">
