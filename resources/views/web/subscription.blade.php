    ...
    <div class="frm-cred-access-box subscription-box" data-bind="visible: visibleSubcription">
        ...
        <div class="subs-holder text-center ">
            ...
            <div class="subscription-inr-box ">
                ...
                <!--<a id="stripe" href="https:/nnnect-link/connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_A4GIpAptEF5hAp1QDsIVsSgNcF4P1QcV&scope=read_write&page=subscription_list" class="btn btn-primary pd-l-10 pd-r-10 mr-t-20 mr-b-20">Get Started</a>-->
                <a href="{{asset('connect-link')}}">Connect</a>
            </div>
