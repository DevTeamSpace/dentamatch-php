            <div class="col-sm-4">
                <div id="ChildVerticalTab_1"  class="cboxbottom">
                    <ul class="resp-tabs-list ver_1 small-border-radius decoration ">
                        ...
                        <li class="{{ ($activeTab==2)?'resp-tab-active':'' }}"><a href ="{{ url('reports/false') }}"><span class="icon icon-drive-document "></span>Reports</a></li>
                        ...
                        <li class="{{ ($activeTab==6)?'resp-tab-active':'' }}"><a href ="{{ url('setting-privacy-policy') }}"><span class="icon icon-text-document-black-interface-symbol"></span>Privacy Policy</a></li>
