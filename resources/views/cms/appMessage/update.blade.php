          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('cms/notify/store') }}">
              ...
              <div class="form-group{{ $errors->has('message_to') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <select class="form-control" name="message_to">
                    <option <?=(($appMessage->message_to == '1') ? 'selected' : '')?> value="1">
                      All
                    </option>
                    <option <?=(($appMessage->message_to == '2') ? 'selected' : '')?> value="2">
                      Recruiter
                    </option>
                    <option <?=(($appMessage->message_to == '3') ? 'selected' : '')?> value="3">
                      Jobseeker
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                                    <textarea class="form-control" rows="7" cols="20" class="form-control"
                                              name="message">{{ $appMessage->message }}</textarea>
